  ...
  return (
    <div className="bg-gray-50 min-h-screen w-full flex justify-center px-4">
      <div className="w-full max-w-sm py-6 overflow-y-auto">
        ...
        <p className="font-semibold mb-4 text-center">반갑습니다!</p>
        ...
        <form>
          ...
          <input
            ...
            className="border w-full px-3 py-2 rounded text-sm mb-1"
          ...
          <div className="space-y-2 text-sm pl-5">
            <label className="flex items-center gap-2">
              ...
              />
              [필수] 이용약관 <span className="text-blue-500 cursor-pointer">[보기]</span>
            </label>
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
              ...
              />
              [필수] 개인정보 수집 이용 동의 <span className="text-blue-500 cursor-pointer">[보기]</span>
            </label>
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
